...
var handleSlimScroll = function() {
    ...
    handleSidebarMenu = function() {
        ...
        $(".sidebar .nav > .has-sub > a").click(function() {
            ...
            0 === $(".page-sidebar-minified").length && ($(b).not(a).slideUp(0, function() {
                $(this).closest("li").removeClass("expand")
            }), $(a).slideToggle(0, function() {
                var b = $(this).closest("li");
                $(b).hasClass("expand") || !$(a).is(":visible") ? $(b).removeClass("expand") : $(b).addClass("expand")
            }))
    ...
    handleThemePageStructureControl = function() {
        if ($.cookie && $.cookie("theme")) {
            ...
            // var a = "portal/css/theme/" + $.cookie("theme") + ".css";
			var a = "portal/css/theme/default.css";
            $("#theme").attr("href", a)
        }
        $.cookie && $.cookie("sidebar-styling") && 0 !== $(".sidebar").length && "grid" == $.cookie("sidebar-styling") && ($(".sidebar").addClass("sidebar-grid"), $('[name=sidebar-styling] option[value="2"]').prop("selected", !0)), $.cookie && $.cookie("header-styling") && 0 !== $(".header").length && "navbar-inverse" == $.cookie("header-styling") && ($(".header").addClass("navbar-inverse"), $('[name=header-styling] option[value="2"]').prop("selected", !0)), $.cookie && $.cookie("content-gradient") && 0 !== $("#page-container").length && "enabled" == $.cookie("content-gradient") && ($("#page-container").addClass("gradient-enabled"), $('[name=content-gradient] option[value="2"]').prop("selected", !0)), $.cookie && $.cookie("content-styling") && 0 !== $("body").length && "black" == $.cookie("content-styling") && ($("body").addClass("flat-black"), $('[name=content-styling] option[value="2"]').prop("selected", !0)), $(".theme-list [data-theme]").click(function() {
            //var a = "portal/css/theme/" + $(this).attr("data-theme") + ".css";
            var a = "portal/css/theme/default.css";
    ...
    handleToggleNavbarSearch = function() {
        $('[data-toggle="navbar-search"]').click(function(a) {
            a.preventDefault(), $(".navbar").addClass("navbar-search-toggled")
        })
    },
    handleDismissNavbarSearch = function() {
        $('[data-dismiss="navbar-search"]').click(function(a) {
            a.preventDefault(), $(".navbar").removeClass("navbar-search-toggled")
        })
    },
    handleToggleNavProfile = function() {
        $('[data-toggle="nav-profile"]').click(function(a) {
            a.preventDefault();
            var b = $(this).closest("li"),
                c = $(".sidebar .nav-profile"),
                d = "active";
            $(b).hasClass(d) ? ($(b).removeClass(d), $(c).removeClass(d)) : ($(b).addClass(d), $(c).addClass(d))
        })
    },
    NanoApp = function() {
        "use strict";
        return {
            ...
            initComponent: function() {
                handleDraggablePanel(), handleIEFullHeightContent(), handleSlimScroll(), handleUnlimitedTabsRender(), handlePanelAction(), handelTooltipPopoverActivation(), handleScrollToTopButton(), handleAfterPageLoadAddClass(), handleToggleNavProfile(), handleDismissNavbarSearch(), handleToggleNavbarSearch()
            },
