...
'whichapi'			=> 'btclive', //Enter which api to use also change default_license id

'default_license' => env('DEFAULT_LICENSE', 1), //id of the default current api
...
'ltctestnet' => [
    'id' => 3,
    'account' => env('BLOCKIO_API_LABEL', 'Litecoin (TESTNET!) API'),
    'apiKey' => env('BLOCKIO_API_KEY', '115c-6a9a-682e-817f'),
    'pin' => env('BLOCKIO_PIN', '1337time'),
    'version' => env('BLOCKIO_VERSION', 2),
    'address' => env('NANOCOIN_ADDRESS', '3Ck8Um73HEQ4tbDdnAuhXGZ4ueuGXJ15Fo'), //CURRENT TESTNET ADDRESS
],
