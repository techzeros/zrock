				...
				<ul class="nav">
					...
					<li>
						<a href="bootstrap_4.html">
							<div class="icon-img">
						    	<img src="{{ asset('portal/img/bs4-logo.png') }}" alt="" />
						    </div>
					...
					<li class="has-sub">
					    ...
					    <ul class="sub-menu">
					        ...
					        <li><a href="http://seantheme.com/color-admin-v3.0/admin/apple/index.html">APPLE DESIGN <i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
					    </ul>
					</li>
					<li class="has-sub">
					    <a href="javascript:;">
